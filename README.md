...
Tentei fazer tudo de uma forma simples e com pouco ou nenhum custo. Para isso utulizei o terraform para subir uma EC2 na aws fazendo uso do free tier. 

Fiz o build da imagem em docker e fiz o deploy usando o dockerhub dentro dessa EC2 utilizando o user data para automatizar essas ações. Da mesma forma o agent do new relic foi instalado e associado a uma conta free que criei.

Queria ter finalizado a configuração do ngnix porem acabei abandonando devido ao tempo.
